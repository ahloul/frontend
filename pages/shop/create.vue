  ...
  <div class="flex flex-col">
    ...
    <div>
      <div class="mt-10 max-w-sm mx-auto">
        ...
        <FormulateForm v-show="step === 2" @submit="submit">
          <p class="tab-heading">
        ...
        <FormulateForm v-show="step === 3" @submit="submit">
          <FormulateInput
        ...
        <FormulateForm v-show="step === 4" @submit="submit">
        ...
        <FormulateForm v-show="step === 5" @submit="submit">
          <p class="tab-heading">
            {{ $t('description.intro') }}
          </p>
...
export default {
  ...
  methods: {
    ...
    submit() {
      if (this.step === 5) this.createShop()
      else this.step++
    },
    async createShop() {
      try {
