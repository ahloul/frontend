export default {
  ...
  information: {
    ...
    legal_form_options: {
      ...
      partnership: 'Personengesellschaft (z. B. GdbR, OHG, KG)',
      sole: 'Einzelunternehmer',
      non_profit: 'Gemeinnützig / Verein',
      private_partnership:
  ...
  contact_data: {
    ...
    intro:
      'Gib die Adresse Deines Shops an damit andere wissen, wo sie Dich finden können.',
    full_address: 'Vollständige Adresse',
    phone_number: 'Telefonnummer',
    prefix_and_number: 'Vorwahl und Nummer',
    website: 'Webseite',
    facebook: 'Facebook',
    instagram: 'Instagram',
    optional: 'Optional',
  ...
  picture: {
    section_name: 'Bilder',
    intro: 'Zeige Deinen Shop mit einem Foto und Deinem Logo.',
    logo: 'Logo',
    shop_picture: 'Bild vom Shop',
  },
  description: {
    section_name: 'Beschreibung',
    intro:
      'Wenn Du möchtest, beschreibe Dein Geschäft mit ein paar Sätzen. Lass Deiner Kreativität freien Lauf!',
  },
  category: {
    title: 'Kategorie',
  ...
  article: {
    ...
    name_hint: 'z.B. Kugelschreiber',
    empty: 'Keine Artikel',
    stock: 'Lagerbestand',
    create_stock: 'Lagerbestand anlegen',
    unit_price: 'Einzelpreis',
    price_hint: 'z.B. 12,00',
    tax_rate: 'Steuersatz',
    tax_free: 'Steuerfrei',
    public_prefix: 'Artikel wird',
