export default {
  ...
  profile: { description: 'Profilbeschreibung', city: 'Wohnort' },
  login: {
  ...
  toast: {
    ...
    shop_not_found: 'Fehler beim Laden deines Shops',
  },
  contact_to_delete:
    'Bitte kontaktiere uns, wenn Du deinen Account löschen möchtest',
